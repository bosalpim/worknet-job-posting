Jets.application.configure do
  ...
  PHONE_NUMBER_WHITELIST = PHONE_NUMBER_WHITELIST.present? ? JSON.parse(PHONE_NUMBER_WHITELIST) : ["01037863607", "01025179362", "01094659404", "01066121746", "01049195808", "01091372316", "01029685055", "01051119300"]
  TEST_PHONE_NUMBER = ENV['TEST_PHONE_NUMBER'] || '01094659404'
