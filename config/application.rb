module Main
  class Application < Jets::Application
    ...
    PHONE_NUMBER_WHITELIST = if ENV['PHONE_NUMBER_WHITELIST'].present?
                               ...
                               %w[01025179362 01094659404 01066121746 01049195808 01091372316 01051119300 01057513286 01034308850 01057540629 01029465752 01047974098 01046781989 01048652989 01020748127]
                             end
