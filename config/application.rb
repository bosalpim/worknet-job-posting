module Main
  class Application < Jets::Application
    ...
    PHONE_NUMBER_WHITELIST = PHONE_NUMBER_WHITELIST.present? ? JSON.parse(PHONE_NUMBER_WHITELIST) :
                               %w[01037863607 01025179362 01094659404 01066121746 01049195808 01091372316 01029685055 01051119300 01098651017 01057513286 01034308850 01057540629 01029465752]
