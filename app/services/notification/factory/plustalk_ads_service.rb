class Notification::Factory::PlustalkAdsService < Notification::Factory::NotificationFactoryClass
  ...
  def initialize(params)
    ...
    @list = PlustalkAdsFilterService.call
    create_message
  end
  ...
  def create_message
    @list.each do |job_posting|
      ...
      link = "#{Main::HTTPS_BUSINESS_URL}/jobs/#{job_posting.public_id}/send_plustalk?#{utm}"
