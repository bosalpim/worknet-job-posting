...
지금바로 동네광고를 시작하여 #{tem_params[:user_name]} 외 #{[tem_params[:count][:job_applications] + tem_params[:count][:contact_messages] + tem_params[:count][:user_saves] - 1, 0].max}명의 지원·문의에 응답해 보세요!",
      buttons: [
        {
          name: '지원 · 문의 확인하기',
          type: 'WL',
